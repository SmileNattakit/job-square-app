...
const SearchField = () => {
  return (
    <div className="flex  justify-center items-start">
      <div className="px-6 py-10 w-full box-border md:px-[15%]">
        ...
        <div className=" gap-2 grid md:flex">
          ...
          <div className="flex gap-2">
            <label className="form-control w-full max-w-xs  ">
              <div className="label">
                <span className="label-text-alt">JOB CATEGORY</span>
              </div>
            ...
            <label className="form-control w-full max-w-xs">
              <div className="label">
                <span className="label-text-alt ">JOB TYPE</span>
              </div>
              <select className="select select-bordered">
                <option disabled selected>
                  Select a type
          ...
          <label className="form-control w-full max-w-xs">
            <div className="label">
              <span className="label-text-alt ">SALARY RANGE</span>
            </div>
            <select className="select select-bordered">
